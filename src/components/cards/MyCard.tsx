      ...
      <Card className="my-card-con">
        ...
        <div className="card-btn-con">
          <Button
            ...
            className="card-btn" variant="contained" style={{ borderRadius: '25px', backgroundColor: '#FF6347' }} size="medium">
            <SentimentVeryDissatisfiedTwoToneIcon />
            <span className="button-text">דלג</span>
          </Button>
          <Button
            onClick={() => props.onNext()}
            className="card-btn" variant="contained" style={{ borderRadius: '25px', backgroundColor: "#46da46" }} size="medium">
